    ...
    >
      ...
      <div className="relative z-10 p-6 md:p-10 bg-black/70 border-8 border-red-800/80 shadow-[10px_10px_0_#000] max-w-md w-full mx-auto pixelated-rendering">
        ...
        <img
          ...
          alt="Pikachu"
          className="floating-element absolute -top-16 right-4 w-24 h-24 pixelated-rendering drop-shadow-[4px_4px_0_#000]"
        />
        ...
        <form ref={formRef} className="space-y-6" onSubmit={handleLogin}>
          ...
          <div className="flex flex-col md:flex-row gap-4 pt-4">
            <PixelButton type="submit" className="flex-1 w-full text-lg py-3">
              LOGIN
            </PixelButton>
            <PixelButton
          ...
          <p className="text-center text-red-300 text-xs mt-4">
            <a
              href="#"
              className="hover:text-red-100 transition-colors duration-200"
            >
              Forgot Password?
            </a>
          </p>
