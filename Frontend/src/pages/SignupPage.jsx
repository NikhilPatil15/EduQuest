    ...
    >
      ...
      >
        {[...Array(50)].map((_, i) => (
          <span
            key={i}
            className="pixel-particle absolute w-1 h-1 bg-red-400/80"
            style={{
      ...
      <div className="relative z-10 p-6 md:p-10 bg-black/70 border-8 border-red-800/80 shadow-[10px_10px_0_#000] max-w-md w-full mx-auto pixelated-rendering">
        ...
        <h2
          ref={formTitleRef}
          className="text-3xl md:text-4xl font-bold text-center text-shadow-pixel mb-8 bg-red-800/30 px-4 py-2 rounded"
        >
          BECOME A TRAINER!
        </h2>
        ...
        <form ref={formRef} className="space-y-6" onSubmit={handleSignup}>
          <div>
            <label
              htmlFor="fullName"
              className="block text-red-200 text-sm mb-2"
            >
              FULL NAME
            </label>
            <input
          ...
          <div>
            <label htmlFor="email" className="block text-red-200 text-sm mb-2">
              EMAIL
            </label>
            <input
              type="email"
          ...
          <div className="flex flex-col md:flex-row gap-4 pt-4">
            <PixelButton
              type="submit"
              className="flex-1 w-full text-lg py-3"
              disabled={isLoading}
            >
